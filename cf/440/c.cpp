...
LL ones[] = {0, 1, 11, 111, 1111, 11111, 111111, 1111111,
             11111111, 111111111, 1111111111, 11111111111, 111111111111, 1111111111111, 11111111111111, 
             111111111111111, 1111111111111111};

int dfs(LL n, int index)
{
    int add = n/ones[index] * index;
    n %= ones[index];
    if (n == 0) {
        return add;
    } else{
        return add + min(index+dfs(ones[index]-n, index-1), dfs(n, index-1));
    }
}
