...
public:
    TreeNode* buildTree(vector<int>& inorder, vector<int>& postorder) {
        ...
        return buildTree2(inorder, 0, size-1,
                          postorder, 0, size-1);
    }

    TreeNode* buildTree2(vector<int>& inorder, int ib, int ie,
        ...
        root->left = buildTree2(inorder, ib, i-1,
                                postorder, pb, pb+delta-1);
        root->right = buildTree2(inorder, i+1, ie,
                                 postorder, pb+delta, pe-1);
        return root;
    }
};
int main()
